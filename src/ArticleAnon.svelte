...
<div class='page' bind:this={component}>
  ...
  <div class='top' id='top'>
    ...
    <div class='icon-container'>
      <a target="_blank" href="https://sites.google.com/g.harvard.edu/research2clinics">
        <div class="svg-icon icon-github" title="Open-source code">
        </div>
        <span>Code</span>
      </a>

      <a target="_blank" href="https://youtu.be/UGiKhlXsM1s">
  ...
  <div class='article'>
    ...
    <p>We provide two options to use GAM Changer to edit your GAM models.
      ...
      You can follow <a href="https://gist.github.com/anonymous2024/6554e8c75980a79a35fb27e78642e95a">this instruction</a> to export GAM model and sample data.
      ...
      You can follow the steps in this <a href="https://colab.research.google.com/drive/1AvVE6MjS69mZ861OZvDuX3elWyta-jJJ?usp=sharing">example notebook</a>.
    </p>
    ...
    <div class="video" style='margin-bottom: 2em;'>
      <Youtube videoId="UGiKhlXsM1s" playerId="demo_video" bind:this={currentPlayer}/>
    </div>
